...
func (x *ScaledObjectRef) GetUid() string {
	if x != nil {
		return x.Uid
	}
	return ""
...
func (x *RawMetric) GetTimestamp() *timestamp.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
const file_metrics_proto_rawDesc = "" +
	"\n" +
	"\rmetrics.proto\x12\x03api\x1a\x1fgoogle/protobuf/timestamp.proto\x1a@k8s.io/metrics/pkg/apis/external_metrics/v1beta1/generated.proto\"u\n" +
